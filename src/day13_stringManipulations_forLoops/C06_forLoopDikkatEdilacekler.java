...
public class C06_forLoopDikkatEdilacekler {
    public static void main(String[] args) {

        // verdigimiz baslangic degeri,bitis sartini saglamazsa
        // forloop calisir ancak for loop body'si devreye girmez

        /*
        for (int i = 0; i >10 ; i++) {
            System.out.print(i + " ");
        }
        // baslangic ddegeri ve degisim sekli hic bir zaman bitis degerine ulasmazsa
        // sonsuz loop olusur
        ...
        */
        ...
        /*
          ...
          Java break; komutunu gordugunde loop'un calistirmayi birakir
         */
