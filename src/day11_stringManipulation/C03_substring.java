...
public class C03_substring {
    public static void main(String[] args) {
        ...
        /*
          ...
          2 turlu kullanimi
          1- baslingic index'ini verirseniz, o indexten sona kadar olan kismi verir
          2- baslangic ve bitis indexlerini verirseniz
          baslangic index'inden (dahil) baslar
          bitis index'ine kadar(haric) aradaki karakterlerini yazdirir
        ...
        // charAt()'e benzer ama arti bir ozellegi var
        // substring bize String verdigi icin manipulation yapmaya devam edebiliriz

        // 6.indexteki harfi buyuk harf olarak yazdirin
