...
public class C02_TreeMapMethodlari {
    public static void main(String[] args) {
        ...
        System.out.println(harfler.tailMap("C"));  // {K=25, L=10, T=5, Z=50} C'yi  bulamadim diye hata vermez C'den sonra olacaklari verir

        System.out.println(harfler.tailMap("L", false)); // L'yi dahil etmeyerek verir    {T=5, Z=50}

        System.out.println(harfler.headMap("T"));  // {A=15, K=25, L=10}
        System.out.println(harfler.headMap("M"));  // {A=15, K=25, L=10} M olsaydi oncesini yazacak sekil de verir
        ...
        System.out.println(harfler.floorKey("K"));  // A  kucuk
        System.out.println(harfler.floorKey("M"));  // L

        // {A=15, K=25, L=10, T=5, Z=50}
        System.out.println(harfler.pollFirstEntry());  // A=15'yi silecek ve bize dondurecek
        System.out.println(harfler);   // {K=25, L=10, T=5, Z=50}

        System.out.println(harfler.pollLastEntry());  // Z=50'yi silecek ve bize dondurecek
        System.out.println(harfler);  // {K=25, L=10, T=5}

        System.out.println(harfler.descendingKeySet());  // [T, L, K]  ters sekilde veriyor
        System.out.println(harfler.descendingMap());  //  {T=5, L=10, K=25} ters sekilde veriyor
        // TreeMap dogal siralidir bunu kalici yapamazsin
