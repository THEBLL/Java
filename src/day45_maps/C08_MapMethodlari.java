...
public class C08_MapMethodlari {
    public static void main(String[] args) {
        ...
        System.out.println(harfler.putIfAbsent("L", 30));  // L yoksa 30 ekle burda L oldugu icin 10 donecek
        System.out.println(harfler);

        // T'nin valuse'sunu 2 katina cikarin
        int value=harfler.get("T"); // 5
        harfler.put("T", 2*value);
        System.out.println(harfler);  // {A=15, T=10, Z=50, K=25, L=10}

        // Z'nin degerini 20 artir
        System.out.println(harfler.compute("Z", (k, v) -> v + 20));  // (key ve value'den olusur) -> value + 20
        System.out.println(harfler);  // {A=15, T=10, Z=70, K=25, L=10}

        // L'nin degerini 3 katinin 5 fazlasi yapin
        System.out.println(harfler.compute("L", (a, b) -> b * 3 + 5));  // 35  k v demek yorunda degiliz
       ...
       // System.out.println(harfler); // {A=15, T=10, Z=70, K=25, L=35, M=50}
        ...
        // T harfi varsa value'sunu 1 artirin
