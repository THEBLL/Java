...
public class C01_Scope {
    ...
    String strClassLevelOlmayan="Java Guzeldir";


    public static void main(String[] args) {
        System.out.println(classLevelStatic);

        //  System.out.println(strClassLevelOlmayan); static olmadigi icin kullanilamaz
...
//  System.out.println(strClassLevelOlmayan); static olmadigi icin kullanilamaz
    ...
    public void staticMethodOlmayan() {  // secici degil ondan instance variable kullanilir staticte kullanilir
        classLevelStatic = 40;
        System.out.println(strClassLevelOlmayan);
